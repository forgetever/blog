...
//定义回调URL通用的URL
define('URL_CALLBACK', 'http://localhost/blog/index.php?m=Index&a=callback&type=');
return array(
	//腾讯QQ登录配置
	'THINK_SDK_QQ' => array(
		'APP_KEY'    => '101306586', //应用注册成功后分配的 APP ID
		'APP_SECRET' => '36ce7f9db94e6a0f83ab4ff1b9aa4697', //应用注册成功后分配的KEY
